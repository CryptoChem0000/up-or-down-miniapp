// Daily One-Tap Poll - Complete UI Code in One File
// This file contains all UI components and styling for the Farcaster Mini App
// Updated with latest features: royal blue theme, custom ETH mark, voting flow, leaderboard integration
...
const HeroHeader = ({
  ...
  title = "ETHEREUM",    // ← set default to ETHEREUM
